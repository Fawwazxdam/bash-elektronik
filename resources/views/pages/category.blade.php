					...
					<div class="shop_sidebar">
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								...
								<li><a href="{{ route('categories-detail', $item->slug) }}">{{ $item->name }}</a></li>
								@empty
				...
				<div class="col-lg-9">
					...
					<div class="shop_content">
						<div class="shop_bar clearfix">
							<div class="shop_product_count">{{ request()->is('category') ? 'All Product' :$category->slug }}</div>
						...
						<div class="product_grid">
							...
							<div class="product_item is_new">
                                ...
                                @else
								<img src="{{ asset('/') }}images/no-photo.png" style="width: auto; height: 50%;" alt="">
                                @endif
									</div>
